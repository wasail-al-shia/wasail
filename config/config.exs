...
config :esbuild,
  ...
  default: [
    args:
      ~w(js/index.js --bundle --target=es2017 --loader:.svg=file --loader:.js=jsx --loader:.woff=file --loader:.woff2=file --loader:.ttf=file --outdir=../priv/static/assets --external:/fonts/* --external:/images/*),
